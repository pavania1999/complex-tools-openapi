...
def register_employee_with_manager(registration_request: EmployeeRegistrationRequest) -> str:
    ...
    :param registration_request: Employee registration request with employee and manager details
    :return: Formatted registration confirmation message
    """
...
if __name__ == '__main__':
    ...
    result = register_employee_with_manager(registration_request)
    print(result)
    ...
    result = register_employee_with_manager(registration_request_senior)
    print(result)
    ...
    result = register_employee_with_manager(registration_request_exec)
    print(result)
